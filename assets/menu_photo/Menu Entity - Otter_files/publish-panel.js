...
const locationData = [
  { name: 'Greens – Culver City',    addr: '7630 Milky Way, Culver City, CA 60099, USA',  badge: false, platforms: defaultPlatforms, expanded: true },
  { name: 'Greens – Santa Monica',   addr: '412 Ocean Ave, Santa Monica, CA 90401, USA',   badge: true,  platforms: defaultPlatforms, expanded: false },
...
function showPrepubPage() {
  ...
  document.getElementById('ppPanelPages').classList.remove('show-step2');
}
