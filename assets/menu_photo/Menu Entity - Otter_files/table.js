...
document.addEventListener('DOMContentLoaded', () => {
  const menuItemsTab = document.getElementById('tab-menu-items');
  const selectAll = menuItemsTab ? menuItemsTab.querySelector('#select-all') : null;
  const rowCheckboxes = menuItemsTab ? menuItemsTab.querySelectorAll('.data-table tbody .table-checkbox') : [];
