...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Toggle button: "Collapse menu" / "Expand menu"
  if (toggleBtn) {
    toggleBtn.addEventListener('mouseenter', function() {
      var label = sidebar.classList.contains('sidebar--collapsed') ? 'Expand menu' : 'Collapse menu';
      showTip(label, toggleBtn);
    });
  ...
  document.querySelectorAll('.sidebar-item__container').forEach(wireTooltip);
