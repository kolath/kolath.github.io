...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const dropdown = document.getElementById('menus-column-toggle-dropdown');
  const listContainer = document.getElementById('menus-column-toggle-list');
  ...
  if (toggleBtn && dropdown) {
    ...
    document.addEventListener('click', (e) => {
      if (!e.target.closest('#menus-column-toggle')) {
